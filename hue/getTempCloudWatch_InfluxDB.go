...
func main() {
	for {
		...
		pushInfluxDB(temperature)
		time.Sleep(time.Second * 60)
	}
}

func pushInfluxDB(temperature float64) {
	// Make client
	c, err := client.NewHTTPClient(client.HTTPConfig{
		Addr: "http://INFLUX_DB:8086",
		//Username: username,
		//Password: password,
	})
	...
	tags := map[string]string{"room": "living_room"}
...
func readSensorsData(ch chan string) string {
	...
	url := "http://LOCAL_IP/api/TOKEN/sensors"
